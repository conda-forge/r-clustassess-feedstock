...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-clustassess-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-clustassess-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-clustassess
# for installing globally
pixi global install r-clustassess
```
...
It is possible to list all of the versions of `r-clustassess` available on your platform:
...
```
pixi search r-clustassess --channel conda-forge
```
